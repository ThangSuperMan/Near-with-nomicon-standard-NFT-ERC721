...
class Token {
  constructor(token_id, owner_id, name, description, media_uri, levels, approved_account_ids) {
...
let NFT = (_dec = NearBindgen({}), _dec2 = initialize(), _dec3 = view(), _dec4 = call({}), _dec5 = view(), _dec6 = view(), _dec(_class = (_class2 = class NFT {
  ...
  constructor() {
    ...
    this.token_by_id = new LookupMap('0');
  }
  initNft({
    owner_id
  }) {
  ...
  nft_approve({
    ...
    log('nft_approve just being executed!');
  }
  mint_nft({
    token_owner_id,
    name,
    ...
    const token = new Token(this.token_id, token_owner_id, name, description, media_uri, levels, approved_account_ids);
  ...
  get_token_by_id({
    ...
    log('get_token_by_id is just being executed!');
  ...
  get_all_tokens() {
    log('get_all_tokens is just being executed!');
    var all_tokens = [];
...
}, (_applyDecoratedDescriptor(_class2.prototype, "initNft", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "initNft"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "nft_approve", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "nft_approve"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "mint_nft", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "mint_nft"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_token_by_id", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "get_token_by_id"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_all_tokens", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "get_all_tokens"), _class2.prototype)), _class2)) || _class);
...
function initNft() {
  ...
  const _contract = NFT._create();
  const _args = NFT._getArgs();
  const _result = _contract.initNft(_args);
  NFT._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(NFT._serialize(_result, true));
}

export { get_all_tokens, get_token_by_id, initNft, mint_nft, nft_approve };
